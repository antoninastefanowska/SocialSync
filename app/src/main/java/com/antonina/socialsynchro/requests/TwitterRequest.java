...
public abstract class TwitterRequest {
    private final static Context context = SocialSynchro.getAppContext();
    ...
    protected void collectBaseParameters() {
        authorizationParameters.put("oauth_consumer_key", APIKey.getKey(context, "twitter_key"));
        ...
        authorizationParameters.put("oauth_token", APIKey.getKey(context, "twitter_token")); // TODO: Token trzeba będzie pobrać od użytkownika.
    ...
    private String buildSigningKey() {
        ...
        sb.append(percentEncode(APIKey.getKey(context, "twitter_secretkey")));
        sb.append("&");
        sb.append(percentEncode(APIKey.getKey(context, "twitter_secrettoken"))); // TODO: Token trzeba będzie pobrać od użytkownika.
